...
public class InvocationExprent extends Exprent {
  ...
  private static final Map<String, String> UNBOXING_METHODS = new HashMap<String, String>() {{
	put("booleanValue", "java/lang/Boolean");
    put("byteValue", "java/lang/Byte");
    put("shortValue", "java/lang/Short");
    put("intValue", "java/lang/Integer");
    put("longValue", "java/lang/Long");
    put("floatValue", "java/lang/Float");
    put("doubleValue", "java/lang/Double");
    put("charValue", "java/lang/Character");
  }};
